  ...
  return (
    <>
      <div className="flex h-screen">
        <div
          className={`h-full ${
            isOpen ? "w-2/3" : "w-[16%] md:w-[7%] lg:w-[4%]"
          } duration-300 fixed z-10 md:w-2/5 lg:w-1/5 flex flex-col bg-white border-r shadow-sm`}
        >
          <div
            className={`p-2 pb-2 flex justify-between items-center ${
              !isOpen && ""
            }`}
          >
            <div className={`flex ${!isOpen && "hidden"}`}>
              <img
                ...
                alt="logo idk"
              />
              <h1 className="p-2 font-bold text-xs md:text-lg lg:text-base">
                Hello, {username}👋
              </h1>
              <h1></h1>
            </div>
            ...
            <div className="flex">
              <div
                className="w-10 flex flex-col gap-0.5 p-2"
              ...
              <Tooltip
                ...
                content={
                  <div className="w-max">
                    ...
                    <p className="text-xs text-[#525C61]">Summary of Items!</p>
                  </div>
                }
              >
                <div
                  ...
                  className={`flex mx-3 transition-all duration-200 my-1 p-1 w-[90%] rounded-md text-gray-600 group hover:text-black hover:font-bold hover:bg-gray-100 hover:cursor-pointer ${
                    !isOpen && "w-[52%] lg:w-[50%] my-2"
                  }`}
                >
                  <svg
                    className="fill-[#6B7280] group-hover:fill-black"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                  ...
                  <h1
                    className={`ml-3 text-sm md:text-lg ${!isOpen && "hidden"}`}
                  >
                    Dashboard
                  </h1>
                </div>
              ...
              <Tooltip
                ...
                content={
                  <div className="w-max">
                    ...
                    <p className="text-xs text-[#525C61]">Items Receive!</p>
                  </div>
                }
              >
                <div
              ...
              <Tooltip
                ...
                content={
                  <div className="w-max">
                    ...
                    <p className="text-xs text-[#525C61]">Items Issued!</p>
                  </div>
                }
              >
                <div
              ...
              <Tooltip
                ...
                content={
                  <div className="w-max">
                    ...
                    <p className="text-xs text-[#525C61]">List of Items!</p>
                  </div>
                }
              >
                <div
              ...
              <Tooltip
                ...
                content={
                  <div className="w-max">
                    ...
                    <p className="text-xs text-[#525C61]">Location of Items!</p>
                  </div>
                }
              >
                <div
              ...
              <Tooltip
                ...
                content={
                  <div className="w-max">
                    ...
                    <p className="text-xs text-[#525C61]">you need help?</p>
                  </div>
                }
              >
                <div
            ...
            >
              <div className="flex m-3">
                ...
                <div className="flex justify-between items-center w-52 ml-3 mb-2">
                  <div
                    className={`flex flex-col leading-6 ${!isOpen && "hidden"}`}
                  >
                    <h4 className="font-semibold text-sm md:text-sm lg:text-base">
                      {username}
                    </h4>
                    <span className="text-xs text-gray-600 md:text-sm lg:text-base">
                      {level >= 2 ? "Admin" : "Guest"}
                    </span>
                  </div>
                </div>
